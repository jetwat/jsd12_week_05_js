...
// -> เพิ่ม else if cancelled ลองรัน -- ลืมใส่ else "Status unknown. Please contact support."
// -> กลับมาอ่านโจทย์ใหม่ เข้าใจผิด นึกว่าอยากให้ไม่ส่งค่าหาก เงื่อนไข `= "cancelled"`
// -> แก้แล้วรันใหม่
